...
How a row in the [README](README.md) history table is produced, and what each of its columns means. The registry frontmatter in [index.md](index.md) is the authority for every path, weight and threshold named here; [guide.md](guide.md) is the runbook a human follows.
